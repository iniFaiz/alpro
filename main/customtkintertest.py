...
def hide_indicate():
    pomodoro_btn.configure(fg_color='#A9CCE3')
    todo_btn.configure(fg_color='#A9CCE3')
...
pomodoro_btn = ctk.CTkButton(sidebar, 
                             ...
                             hover_color="#5084B9", 
                             height=50,
                             command= lambda: indicate(pomodoro_btn, pomodoro))
...
# Label untuk pomodoro timer
pomodoro_timer_label = ctk.CTkLabel(main_content, 
                                    text="25:00", 
                                    font=("Helvetica", 180))
pomodoro_timer_label.pack(pady=100)
 
# Variabel global untuk menyimpan status pomodoro
...
def update_pomodoro_timer():
    ...
    if pomodoro_running and pomodoro_time > 0:
        ...
        if pomodoro_timer_label.winfo_exists():  # Check if the label widget exists
        ...
        pomodoro_running = False
        if pomodoro_timer_label.winfo_exists():
            pomodoro_timer_label.configure(text="25:00")
